...
@section('backendcontent')
    <div class="page-header mt-0 shadow p-3">
        ...
        <div class="btn-group mb-0">
            <a href="{{ route('event.create') }}" class="btn btn-primary  mb-0"><i class="fas fa-cog mr-2"></i>Add New Events</a>
        </div>
    </div>
    @if (session('success'))
                        ...
                        <table id="event" class="table table-striped table-bordered w-100 text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $event->name }}</td>
                                    <td>{{ $event->nepali_event_date }}</td>
                                    <td>
                                        <div class="">
                                            <div class="">    
                                                <a href="{{ route('event.show', $event->id) }}" class="btn btn-sm btn-primary">View</a>
                                            </div>
                                            <div class=""> 
