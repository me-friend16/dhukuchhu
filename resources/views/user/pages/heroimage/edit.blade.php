        ...
        <div class="col-lg">
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="{{ route('heroimage.update', $heroimage->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid state-invalid @enderror" name="name" placeholder="Enter Hero Image Name" value="{{ $heroimage->name }}" required>
                                    @error('name')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('link') is-invalid state-invalid @enderror" id="link" name="link" rows="4" placeholder="Link here..">{{ $heroimage->link }}</textarea>
                                </div>
                                @error('link')
