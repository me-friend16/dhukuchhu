          ...
          <div class="accordion-img">
            <div class="d-flex align-items-center hoverimg">
              <figure class="accordion-img-1">
                <img src="{{ asset('frontend') }}/assets/img/accordion-img-1.jpg" alt="img">
              </figure>
              <figure class="accordion-img-2">
                <img src="{{ asset('frontend') }}/assets/img/accordion-img-2.jpg" alt="img">
              </figure>
            </div>
            <div class="hoverimg">
              <figure>
                <img src="{{ asset('frontend') }}/assets/img/accordion-img-3.jpg" alt="img">
              </figure>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          ...
          <div class="accordion">
            <div class="accordion-item">
              ...
              <div class="content">
                <p>typefaces and layouts, and in appeara nce of different general the content of dummy text is
                  nonsensical.typefaces of dummy text is nonsensical.</p>
              </div>
            </div>
